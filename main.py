...
def main():
    ...
    for no_hidden_neurons in [ 200, 400 ]:
        ...
        print("Saving model in data_hog", str(no_hidden_neurons), ".npy file")
        save_model_file(model, "data_hog" + str(no_hidden_neurons))  # save model file. we can use it later for prediction.
    ...
    for no_hidden_neurons in [ 200, 400 ]:
        ...
        model = loadModelFile(
            "data_hog" + str(no_hidden_neurons))  # load model file for getting weights and bias.
